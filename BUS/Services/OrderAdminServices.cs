            ...
            try
            {
                ...
                var result = orders.Select(o =>
                {
                    ...
                    return new AdminOrderListItem
                    {
                        ...
                        CustomerName = o.Name ?? o.User?.FullName ?? "Khách vãng lai",
                        CustomerPhone = o.Phone ?? o.User?.Phone ?? "",
            ...
            try
            {
                ...
                var detail = new AdminOrderDetail
                {
                    ...
                    Customer = new OrderCustomerInfo
                    {
                        ...
                        // Thông tin KHÁCH HÀNG MUA - luôn lấy từ User
                    ...
                    {
                        // Thông tin NGƯỜI NHẬN - ưu tiên lấy từ Order (có thể khác người mua)
                        ReceiverName = order.Name ?? order.User?.FullName ?? "",
